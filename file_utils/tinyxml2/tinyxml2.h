...
distribution.
*/
//https://github.com/leethomason/tinyxml2/blob/master/tinyxml2.h
...
public:
    ...
    void Trace( const char* name ) {
        printf( "Mempool %s watermark=%d [%dk] currentSolution_=%d size=%d nAlloc=%d blocks=%d\n",
...
public:
    ...
    */
    ...
    /**
    	...
    	from the currentSolution_ Document. (this->GetDocument())
    ...
    */
	...
	/**
		...
		be allocated in the currentSolution_ document. If 'target'
...
/** In correct XML the declaration is the first entry in the file.
	...
	TinyXML-2 will happily read or writeLine files without a declaration,
	however.
...
public:
    ...
    /** Given an attribute name, Attribute() returns the value
    	...
    	match. This allow you to writeLine code:
...
public:
    ...
    */
    ...
    /** Sets whether to writeLine the BOM when writing the file.
    */
...
/**
	...
	easy to writeLine a *lot* of code that looks like:
...
public:
    ...
    */
    ...
    /** If streaming, writeLine the BOM and declaration. */
...
private:
    /**
       Prepares to writeLine a new node. This includes sealing an element that was
